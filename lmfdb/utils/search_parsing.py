...
def nf_string_to_label(FF):
    ...
    Supports custom nicknames of the form Q(s1, s2, ..., sk), where si is a string representing some algebraic element.
    Uses _nf_string_to_qqbar to parse strings represents algebraic elements into elements in QQbar.
    Uses number_field_elements_from_algebraics to compute number field generated by elements in QQbar.

    Examples: Q, Qsqrt2, Qsqrt-4, Qzeta5, Q(sqrt2+sqrt3), Qcbrt2, Q(sqrt(2 + 3*sqrt2)), Q(sqrt2, cbrt3)
    """
